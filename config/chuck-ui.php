...
return [
    ...
    | By default all components from Chuck UI Kit are loaded in. You can
    ...
    */
    ...
    'components' => [
        ...
        'input-addon' => Components\Forms\Inputs\Addon::class,
        ...
        'navbar' => Components\Navs\Navbar::class,
        'nav-dropdown' => Components\Navs\NavDropdown::class,
        'nav-item' => Components\Navs\NavItem::class,
        'nav-link' => Components\Navs\NavLink::class,
    ...
    | for your app. By default all components from Chuck UI Kit are loaded in.
    |
    */
    ...
    |--------------------------------------------------------------------------
    |
    | This value will set a prefix for all Chuck UI Kit components.
    | By default it's empty. This is useful if you want to avoid
    | collision with components from other libraries.
    |
    | If set with "chuck", for example, you can reference components like:
    |
    | <x-chuck-easy-mde />
    |
    */
